...
class __TwigTemplate_53ec29912d7e5bf50ad5d9d2f6bfe0c3e150ef31f63f5b12cc4bc70bb6f54183 extends \Twig\Template
{
...
";
    ...
    public function block_category_thumbnail_image($context, array $blocks = [])
    {
        ...
        // line 27
        echo "  ";
        if (((isset($context["thumbnailImage"]) || array_key_exists("thumbnailImage", $context)) &&  !(null === ($context["thumbnailImage"] ?? $this->getContext($context, "thumbnailImage"))))) {
            // line 28
            echo "    <div>
      <figure class=\"figure\">
        <img src=\"";
            // line 30
            echo twig_escape_filter($this->env, $this->getAttribute(($context["thumbnailImage"] ?? $this->getContext($context, "thumbnailImage")), "path", []), "html", null, true);
        ...
        <figcaption class=\"figure-caption\">";
            ...
            echo " ";
            echo twig_escape_filter($this->env, $this->getAttribute(($context["thumbnailImage"] ?? $this->getContext($context, "thumbnailImage")), "size", []), "html", null, true);
            echo "</figcaption>
      </figure>
    </div>
  ";
    ...
    {
        return array (  69 => 31,  65 => 30,  61 => 28,  58 => 27,  40 => 26,  37 => 25,);
    }
...
{% block category_thumbnail_image %}
  ...
  {% endif %}
{% endblock %}
", "@PrestaShop/Admin/Sell/Catalog/Categories/Blocks/thumbnail_image.html.twig", "/var/www/html/src/PrestaShopBundle/Resources/views/Admin/Sell/Catalog/Categories/Blocks/thumbnail_image.html.twig");
    }
}
