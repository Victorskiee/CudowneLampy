...
class __TwigTemplate_6dd9f73636e87ffcb2cbf3f70484c063165a90c40f7b3ae5eeb941a3c79bd656 extends \Twig\Template
{
    ...
    \$(document).ready(function() {
        ...
        if (value != '') {
            ...
            value = value.replace('<=', '";
        // line 37
        echo twig_escape_filter($this->env, (((isset($context["min"]) || array_key_exists("min", $context))) ? (_twig_default_filter(($context["min"] ?? $this->getContext($context, "min")), "0")) : ("0")), "html", null, true);
        echo ",');
            value = value.replace('>=', '";
        // line 38
        echo twig_escape_filter($this->env, (((isset($context["max"]) || array_key_exists("max", $context))) ? (_twig_default_filter(($context["max"] ?? $this->getContext($context, "max")), "1000000000")) : ("1000000000")), "html", null, true);
        echo ",');
            value = value.split(',');
...
<div id=\"";
    ...
    <input class=\"form-control form-min-max\" type=\"text\" id=\"";
        ...
        echo twig_escape_filter($this->env, (((isset($context["minLabel"]) || array_key_exists("minLabel", $context))) ? (_twig_default_filter(($context["minLabel"] ?? $this->getContext($context, "minLabel")), "Min")) : ("Min")), "html", null, true);
        echo "\" ";
        if ((((isset($context["disabled"]) || array_key_exists("disabled", $context))) ? (_twig_default_filter(($context["disabled"] ?? $this->getContext($context, "disabled")), false)) : (false))) {
            echo "disabled";
        }
        echo " />
    <input class=\"form-control form-min-max\" type=\"text\" id=\"";
        ...
        echo twig_escape_filter($this->env, (((isset($context["maxLabel"]) || array_key_exists("maxLabel", $context))) ? (_twig_default_filter(($context["maxLabel"] ?? $this->getContext($context, "maxLabel")), "Max")) : ("Max")), "html", null, true);
        echo "\" ";
        if ((((isset($context["disabled"]) || array_key_exists("disabled", $context))) ? (_twig_default_filter(($context["disabled"] ?? $this->getContext($context, "disabled")), false)) : (false))) {
            echo "disabled";
        }
